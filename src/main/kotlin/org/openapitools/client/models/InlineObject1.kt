 ...
 * @param categoryPath Categories's path associated with this product. This can replace the `CategoryId` field.
 * @param brandName Brand name associated with this product. This can replace the `BrandId` field.
...
data class InlineObject1 (
    ...
    /* Categories's path associated with this product. This can replace the `CategoryId` field. */
    @Json(name = "CategoryPath")
    val categoryPath: kotlin.String? = null,

    /* Brand name associated with this product. This can replace the `BrandId` field. */
    @Json(name = "BrandName")
