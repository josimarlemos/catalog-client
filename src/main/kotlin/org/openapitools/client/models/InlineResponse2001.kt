 ...
 * 
 *
 * @param id Product’s unique numerical identifier.
 ...
 * @param descriptionShort Product Short description. This information is presented by:  Store Framework: `$product.DescriptionShort` control. And can be displayed on both the product page and the shelf.  
...
data class InlineResponse2001 (
    ...
    /* Product Short description. This information is presented by:  Store Framework: `$product.DescriptionShort` control. And can be displayed on both the product page and the shelf.   */
