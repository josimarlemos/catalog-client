 ...
 * @param isRequired If the attachment is required or not
 * @param isActive If the attachment is active or not
 * @param domains Attachment list of characteristics
 */

data class ResquetBody1 (

    /* Attachment Name */
    @Json(name = "Name")
    val name: kotlin.String = "Test",

    /* If the attachment is required or not */
    @Json(name = "IsRequired")
    val isRequired: kotlin.Boolean = true,

    /* If the attachment is active or not */
    @Json(name = "IsActive")
    val isActive: kotlin.Boolean = true,

    /* Attachment list of characteristics */
    @Json(name = "Domains")
    val domains: kotlin.collections.List<kotlin.Any> = arrayListOf()
