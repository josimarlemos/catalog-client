 ...
 * 
 *
 * @param skuId SKU reference ID that you need identify the SKUs.
 * @param attachmentNames Array with all the names of attachments that you need to associate to the SKU.
 */

data class AssociateattachmentstoSKURequest (

    /* SKU reference ID that you need identify the SKUs. */
    @Json(name = "SkuId")
    val skuId: kotlin.collections.List<kotlin.String>,

    /* Array with all the names of attachments that you need to associate to the SKU. */
    @Json(name = "AttachmentNames")
    val attachmentNames: kotlin.collections.List<kotlin.String>
