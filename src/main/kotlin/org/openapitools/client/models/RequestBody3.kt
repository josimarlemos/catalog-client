 ...
 * @param skuId SKU in which you are inserting as a Complement in the Parent SKU
...
data class RequestBody3 (
    ...
    @Json(name = "ComplementTypeId")
    val complementTypeId: kotlin.Int = 1
