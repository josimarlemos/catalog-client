 ...
 * @param skuServiceTypeId An explanation about the purpose of this instance.
 */

data class RequestBody7 (

    /* Attachment ID */
    @Json(name = "AttachmentId")
    val attachmentId: kotlin.Int = 1,

    /* An explanation about the purpose of this instance. */
    @Json(name = "SkuServiceTypeId")
    val skuServiceTypeId: kotlin.Int = 1
