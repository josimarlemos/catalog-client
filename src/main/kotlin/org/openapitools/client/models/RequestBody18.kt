 ...
 * @param text Specification Value Text
 * @param isActive Shows if the Category is active or not
 * @param position The current Specification Value’s position in comparison to the others
 */

data class RequestBody18 (

    /* Field ID */
    @Json(name = "FieldId")
    val fieldId: kotlin.Int = 1,
    ...
    /* The current Specification Value’s position in comparison to the others */
    @Json(name = "Position")
