...
open class ApiClient(val baseUrl: String) {
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["X-VTEX-API-AppKey"].isNullOrEmpty()) {
            if (apiKey["X-VTEX-API-AppKey"] != null) {
                if (apiKeyPrefix["X-VTEX-API-AppKey"] != null) {
                    requestConfig.headers["X-VTEX-API-AppKey"] = apiKeyPrefix["X-VTEX-API-AppKey"]!! + " " + apiKey["X-VTEX-API-AppKey"]!!
                } else {
                    requestConfig.headers["X-VTEX-API-AppKey"] = apiKey["X-VTEX-API-AppKey"]!!
                }
            }
        }
        if (requestConfig.headers["X-VTEX-API-AppToken"].isNullOrEmpty()) {
            if (apiKey["X-VTEX-API-AppToken"] != null) {
                if (apiKeyPrefix["X-VTEX-API-AppToken"] != null) {
                    requestConfig.headers["X-VTEX-API-AppToken"] = apiKeyPrefix["X-VTEX-API-AppToken"]!! + " " + apiKey["X-VTEX-API-AppToken"]!!
                } else {
                    requestConfig.headers["X-VTEX-API-AppToken"] = apiKey["X-VTEX-API-AppToken"]!!
                }
            }
        }
    }
